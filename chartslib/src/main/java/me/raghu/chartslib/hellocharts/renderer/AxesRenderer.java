package me.raghu.chartslib.hellocharts.renderer;
...
import me.raghu.chartslib.hellocharts.model.Axis;
import me.raghu.chartslib.hellocharts.model.AxisValue;
import me.raghu.chartslib.hellocharts.model.Viewport;
import me.raghu.chartslib.hellocharts.util.AxisAutoValues;
import me.raghu.chartslib.hellocharts.util.ChartUtils;
import me.raghu.chartslib.hellocharts.util.FloatUtils;
import me.raghu.chartslib.hellocharts.view.Chart;
...
public class AxesRenderer {
    private static final int DEFAULT_AXIS_MARGIN_DP = 20;
    ...
    private void drawAxisLabelsAndName(Canvas canvas, Axis axis, int position) {
        ...
        if (!TextUtils.isEmpty(axis.getName())) {
            if (isAxisVertical) {
                ...
                canvas.drawText(axis.getName(), contentRectMargins.centerY(), nameBaselineTab[position]-20,
