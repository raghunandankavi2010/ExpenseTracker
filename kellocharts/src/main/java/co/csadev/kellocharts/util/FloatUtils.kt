...
object FloatUtils {
     ...
     */
    fun almostEqual(ma: Float, mb: Float, absoluteDiff: Float, relativeDiff: Float): Boolean {
        var a = ma
        var b = mb
     ...
     */
    fun formatFloat(formattedValue: CharArray, mvalue: Float, endIndex: Int, mdigits: Int, separator: Char): Int {
        var value = mvalue
        var digits = mdigits
     ...
     */
    fun computeAutoGeneratedAxisValues(start: Float, stop: Float, steps: Int, outValues: AxisAutoValues) {
