...
class Viewport(var left: Float = 0f, var top: Float = 0f, var right: Float = 0f, var bottom: Float = 0f) : Parcelable {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (javaClass != other.javaClass)
            return false
        val mOther = other as Viewport?
        if (java.lang.Float.floatToIntBits(bottom) != java.lang.Float.floatToIntBits(mOther!!.bottom))
            return false
        if (java.lang.Float.floatToIntBits(left) != java.lang.Float.floatToIntBits(mOther.left))
            return false
        if (java.lang.Float.floatToIntBits(right) != java.lang.Float.floatToIntBits(mOther.right))
            return false
        return java.lang.Float.floatToIntBits(top) == java.lang.Float.floatToIntBits(mOther.top)
    }
    ...
    companion object CREATOR : Parcelable.Creator<Viewport> {
